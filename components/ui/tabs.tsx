...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-full items-center justify-center rounded-full bg-muted text-muted-foreground border border-default-color",
      className
    )}
    {...props}
  />
