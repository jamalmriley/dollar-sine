...
export function IntegrationsDemo({ className }: { className?: string }) {
  ...
  return (
    <div
      className={cn(
        "relative flex size-full items-center justify-center overflow-hidden px-5",
        className
      )}
      ref={containerRef}
    >
      <div className="flex size-full max-w-lg flex-row items-stretch justify-between gap-10">
        <div className="flex flex-col justify-center">
          <div
            ref={div7Ref}
            className="size-16 rounded-full overflow-hidden z-50"
          >
            {user ? <img src={user.imageUrl} alt="" /> : <Icons.user />}
          </div>
        </div>
        <div className="flex flex-col justify-center">
          <div
            ref={div6Ref}
            className="size-16 rounded-full overflow-hidden z-50 flex justify-center items-center bg-foreground p-2"
          >
            <Image src={LightLogo} alt="Dollar Sine Logo" />
          </div>
        </div>
