...
import {
  TeacherProfileCard,
  TeacherProfileCardError,
  TeacherProfileCardSkeleton,
} from "./TeacherProfileCard";
import {
  Card,
  CardContent,
  CardDescription,
...
export default function TeacherProfileAlreadyCreated() {
    ...
    <Card className="w-full h-full mx-10 max-w-lg">
      ...
      <CardContent>
        <div className="flex flex-col border border-default-color rounded-lg overflow-hidden">
          {isLoading ? (
            <TeacherProfileCardSkeleton toggle={toggle} />
          ) : userData ? (
            <TeacherProfileCard toggle={toggle} userData={userData} />
          ) : (
            <TeacherProfileCardError toggle={toggle} />
          )}
