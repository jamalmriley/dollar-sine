...
export default function AdminFinishProfile() {
  const {
    isLoading,
    setIsLoading,
    currOnboardingStep,
      ...
      <CardContent>
        ...
        >
          <div className="hidden md:block">
            <AdminFinishProfileDesktop />
          </div>

          <div className="block md:hidden">
            <AdminFinishProfileMobile />
          </div>
...
function AdminFinishProfileDesktop() {
  return (
...
function AdminFinishProfileMobile() {
